...
class PaymentAccountFragment :
    ...
    override fun FragmentPaymentAccountBinding.initUI(savedInstanceState: Bundle?) {
        setTitle(R.string.account_payment.asStringValue)
        inputNumber.editText.hint = getString(R.string.account_number_hint)
        ...
        inputPin.editText.hint = getString(R.string.account_number_pin)
