...
class PointerPopupWindow private constructor(context: Context, width: Int, height: Int) :
    ...
    private var mAlignMode = AlignMode.AUTO_OFFSET

    constructor(context: Context, width: Int) : this(
        context,
        width,
    ...
    fun showAsPointer(anchor: View, itemsCount: Int) {
        showAsPointer(
            anchor, 0,
            -(itemsCount - 1) * 40
        )
